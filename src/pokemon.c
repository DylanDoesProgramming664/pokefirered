...
// NOTE: The order of the elements in the 4 arrays below is irrelevant.
...
static const u16 sSpeciesToKantoPokedexNum[NUM_SPECIES - 1] = 
{
    ...
    SPECIES_TO_KANTO(CHIKORITA),
    SPECIES_TO_KANTO(BAYLEEF),
    SPECIES_TO_KANTO(MEGANIUM),
    SPECIES_TO_KANTO(CYNDAQUIL),
    SPECIES_TO_KANTO(QUILAVA),
    SPECIES_TO_KANTO(TYPHLOSION),
    SPECIES_TO_KANTO(TOTODILE),
    SPECIES_TO_KANTO(CROCONAW),
    SPECIES_TO_KANTO(FERALIGATR),
    SPECIES_TO_KANTO(SENTRET),
    SPECIES_TO_KANTO(FURRET),
    SPECIES_TO_KANTO(HOOTHOOT),
    SPECIES_TO_KANTO(NOCTOWL),
    SPECIES_TO_KANTO(LEDYBA),
    SPECIES_TO_KANTO(LEDIAN),
    SPECIES_TO_KANTO(SPINARAK),
    SPECIES_TO_KANTO(ARIADOS),
    SPECIES_TO_KANTO(CHINCHOU),
    SPECIES_TO_KANTO(LANTURN),
    SPECIES_TO_KANTO(PICHU),
    SPECIES_TO_KANTO(CLEFFA),
    SPECIES_TO_KANTO(IGGLYBUFF),
    SPECIES_TO_KANTO(TOGEPI),
    SPECIES_TO_KANTO(TOGETIC),
    SPECIES_TO_KANTO(NATU),
    SPECIES_TO_KANTO(XATU),
    SPECIES_TO_KANTO(MAREEP),
    SPECIES_TO_KANTO(FLAAFFY),
    SPECIES_TO_KANTO(AMPHAROS),
    SPECIES_TO_KANTO(MARILL),
    SPECIES_TO_KANTO(AZUMARILL),
    SPECIES_TO_KANTO(SUDOWOODO),
    SPECIES_TO_KANTO(HOPPIP),
    SPECIES_TO_KANTO(SKIPLOOM),
    SPECIES_TO_KANTO(JUMPLUFF),
    SPECIES_TO_KANTO(AIPOM),
    SPECIES_TO_KANTO(SUNKERN),
    SPECIES_TO_KANTO(SUNFLORA),
    SPECIES_TO_KANTO(YANMA),
    SPECIES_TO_KANTO(WOOPER),
    SPECIES_TO_KANTO(QUAGSIRE),
    SPECIES_TO_KANTO(MURKROW),
    SPECIES_TO_KANTO(MISDREAVUS),
    SPECIES_TO_KANTO(UNOWN),
    SPECIES_TO_KANTO(WOBBUFFET),
    SPECIES_TO_KANTO(GIRAFARIG),
    SPECIES_TO_KANTO(PINECO),
    SPECIES_TO_KANTO(FORRETRESS),
    SPECIES_TO_KANTO(DUNSPARCE),
    SPECIES_TO_KANTO(GLIGAR),
    SPECIES_TO_KANTO(SNUBBULL),
    SPECIES_TO_KANTO(GRANBULL),
    SPECIES_TO_KANTO(QWILFISH),
    SPECIES_TO_KANTO(SHUCKLE),
    SPECIES_TO_KANTO(HERACROSS),
    SPECIES_TO_KANTO(SNEASEL),
    SPECIES_TO_KANTO(TEDDIURSA),
    SPECIES_TO_KANTO(URSARING),
    SPECIES_TO_KANTO(SLUGMA),
    SPECIES_TO_KANTO(MAGCARGO),
    SPECIES_TO_KANTO(SWINUB),
    SPECIES_TO_KANTO(PILOSWINE),
    SPECIES_TO_KANTO(CORSOLA),
    SPECIES_TO_KANTO(REMORAID),
    SPECIES_TO_KANTO(OCTILLERY),
    SPECIES_TO_KANTO(DELIBIRD),
    SPECIES_TO_KANTO(MANTINE),
    SPECIES_TO_KANTO(SKARMORY),
    SPECIES_TO_KANTO(HOUNDOUR),
    SPECIES_TO_KANTO(HOUNDOOM),
    SPECIES_TO_KANTO(PHANPY),
    SPECIES_TO_KANTO(DONPHAN),
    SPECIES_TO_KANTO(STANTLER),
    SPECIES_TO_KANTO(SMEARGLE),
    SPECIES_TO_KANTO(TYROGUE),
    SPECIES_TO_KANTO(HITMONTOP),
    SPECIES_TO_KANTO(SMOOCHUM),
    SPECIES_TO_KANTO(ELEKID),
    SPECIES_TO_KANTO(MAGBY),
    SPECIES_TO_KANTO(MILTANK),
    SPECIES_TO_KANTO(RAIKOU),
    SPECIES_TO_KANTO(ENTEI),
    SPECIES_TO_KANTO(SUICUNE),
    SPECIES_TO_KANTO(LARVITAR),
    SPECIES_TO_KANTO(PUPITAR),
    SPECIES_TO_KANTO(TYRANITAR),
    SPECIES_TO_KANTO(LUGIA),
    SPECIES_TO_KANTO(HO_OH),
    SPECIES_TO_KANTO(CELEBI),
    SPECIES_TO_KANTO(TREECKO),
    SPECIES_TO_KANTO(GROVYLE),
    SPECIES_TO_KANTO(SCEPTILE),
    SPECIES_TO_KANTO(TORCHIC),
    SPECIES_TO_KANTO(COMBUSKEN),
    SPECIES_TO_KANTO(BLAZIKEN),
    SPECIES_TO_KANTO(MUDKIP),
    SPECIES_TO_KANTO(MARSHTOMP),
    SPECIES_TO_KANTO(SWAMPERT),
    SPECIES_TO_KANTO(POOCHYENA),
    SPECIES_TO_KANTO(MIGHTYENA),
    SPECIES_TO_KANTO(ZIGZAGOON),
    SPECIES_TO_KANTO(LINOONE),
    SPECIES_TO_KANTO(WURMPLE),
    SPECIES_TO_KANTO(SILCOON),
    SPECIES_TO_KANTO(BEAUTIFLY),
    SPECIES_TO_KANTO(CASCOON),
    SPECIES_TO_KANTO(DUSTOX),
    SPECIES_TO_KANTO(LOTAD),
    SPECIES_TO_KANTO(LOMBRE),
    SPECIES_TO_KANTO(LUDICOLO),
    SPECIES_TO_KANTO(SEEDOT),
    SPECIES_TO_KANTO(NUZLEAF),
    SPECIES_TO_KANTO(SHIFTRY),
    SPECIES_TO_KANTO(TAILLOW),
    SPECIES_TO_KANTO(SWELLOW),
    SPECIES_TO_KANTO(WINGULL),
    SPECIES_TO_KANTO(PELIPPER),
    SPECIES_TO_KANTO(RALTS),
    SPECIES_TO_KANTO(KIRLIA),
    SPECIES_TO_KANTO(GARDEVOIR),
    SPECIES_TO_KANTO(SURSKIT),
    SPECIES_TO_KANTO(MASQUERAIN),
    SPECIES_TO_KANTO(SHROOMISH),
    SPECIES_TO_KANTO(BRELOOM),
    SPECIES_TO_KANTO(SLAKOTH),
    SPECIES_TO_KANTO(VIGOROTH),
    SPECIES_TO_KANTO(SLAKING),
    SPECIES_TO_KANTO(NINCADA),
    SPECIES_TO_KANTO(NINJASK),
    SPECIES_TO_KANTO(SHEDINJA),
    SPECIES_TO_KANTO(WHISMUR),
    SPECIES_TO_KANTO(LOUDRED),
    SPECIES_TO_KANTO(EXPLOUD),
    SPECIES_TO_KANTO(MAKUHITA),
    SPECIES_TO_KANTO(HARIYAMA),
    SPECIES_TO_KANTO(AZURILL),
    SPECIES_TO_KANTO(NOSEPASS),
    SPECIES_TO_KANTO(SKITTY),
    SPECIES_TO_KANTO(DELCATTY),
    SPECIES_TO_KANTO(SABLEYE),
    SPECIES_TO_KANTO(MAWILE),
    SPECIES_TO_KANTO(ARON),
    SPECIES_TO_KANTO(LAIRON),
    SPECIES_TO_KANTO(AGGRON),
    SPECIES_TO_KANTO(MEDITITE),
    SPECIES_TO_KANTO(MEDICHAM),
    SPECIES_TO_KANTO(ELECTRIKE),
    SPECIES_TO_KANTO(MANECTRIC),
    SPECIES_TO_KANTO(PLUSLE),
    SPECIES_TO_KANTO(MINUN),
    SPECIES_TO_KANTO(VOLBEAT),
    SPECIES_TO_KANTO(ILLUMISE),
    SPECIES_TO_KANTO(ROSELIA),
    SPECIES_TO_KANTO(GULPIN),
    SPECIES_TO_KANTO(SWALOT),
    SPECIES_TO_KANTO(CARVANHA),
    SPECIES_TO_KANTO(SHARPEDO),
    SPECIES_TO_KANTO(WAILMER),
    SPECIES_TO_KANTO(WAILORD),
    SPECIES_TO_KANTO(NUMEL),
    SPECIES_TO_KANTO(CAMERUPT),
    SPECIES_TO_KANTO(TORKOAL),
    SPECIES_TO_KANTO(SPOINK),
    SPECIES_TO_KANTO(GRUMPIG),
    SPECIES_TO_KANTO(SPINDA),
    SPECIES_TO_KANTO(TRAPINCH),
    SPECIES_TO_KANTO(VIBRAVA),
    SPECIES_TO_KANTO(FLYGON),
    SPECIES_TO_KANTO(CACNEA),
    SPECIES_TO_KANTO(CACTURNE),
    SPECIES_TO_KANTO(SWABLU),
    SPECIES_TO_KANTO(ALTARIA),
    SPECIES_TO_KANTO(ZANGOOSE),
    SPECIES_TO_KANTO(SEVIPER),
    SPECIES_TO_KANTO(LUNATONE),
    SPECIES_TO_KANTO(SOLROCK),
    SPECIES_TO_KANTO(BARBOACH),
    SPECIES_TO_KANTO(WHISCASH),
    SPECIES_TO_KANTO(CORPHISH),
    SPECIES_TO_KANTO(CRAWDAUNT),
    SPECIES_TO_KANTO(BALTOY),
    SPECIES_TO_KANTO(CLAYDOL),
    SPECIES_TO_KANTO(LILEEP),
    SPECIES_TO_KANTO(CRADILY),
    SPECIES_TO_KANTO(ANORITH),
    SPECIES_TO_KANTO(ARMALDO),
    SPECIES_TO_KANTO(FEEBAS),
    SPECIES_TO_KANTO(MILOTIC),
    SPECIES_TO_KANTO(CASTFORM),
    SPECIES_TO_KANTO(KECLEON),
    SPECIES_TO_KANTO(SHUPPET),
    SPECIES_TO_KANTO(BANETTE),
    SPECIES_TO_KANTO(DUSKULL),
    SPECIES_TO_KANTO(DUSCLOPS),
    SPECIES_TO_KANTO(TROPIUS),
    SPECIES_TO_KANTO(CHIMECHO),
    SPECIES_TO_KANTO(ABSOL),
    SPECIES_TO_KANTO(WYNAUT),
    SPECIES_TO_KANTO(SNORUNT),
    SPECIES_TO_KANTO(GLALIE),
    SPECIES_TO_KANTO(SPHEAL),
    SPECIES_TO_KANTO(SEALEO),
    SPECIES_TO_KANTO(WALREIN),
    SPECIES_TO_KANTO(CLAMPERL),
    SPECIES_TO_KANTO(HUNTAIL),
    SPECIES_TO_KANTO(GOREBYSS),
    SPECIES_TO_KANTO(RELICANTH),
    SPECIES_TO_KANTO(LUVDISC),
    SPECIES_TO_KANTO(BAGON),
    SPECIES_TO_KANTO(SHELGON),
    SPECIES_TO_KANTO(SALAMENCE),
    SPECIES_TO_KANTO(BELDUM),
    SPECIES_TO_KANTO(METANG),
    SPECIES_TO_KANTO(METAGROSS),
    SPECIES_TO_KANTO(REGIROCK),
    SPECIES_TO_KANTO(REGICE),
    SPECIES_TO_KANTO(REGISTEEL),
    SPECIES_TO_KANTO(LATIAS),
    SPECIES_TO_KANTO(LATIOS),
    SPECIES_TO_KANTO(KYOGRE),
    SPECIES_TO_KANTO(GROUDON),
    SPECIES_TO_KANTO(RAYQUAZA),
    SPECIES_TO_KANTO(JIRACHI),
    SPECIES_TO_KANTO(DEOXYS),
    SPECIES_TO_KANTO(OLD_UNOWN_B),
    SPECIES_TO_KANTO(OLD_UNOWN_C),
    SPECIES_TO_KANTO(OLD_UNOWN_D),
    SPECIES_TO_KANTO(OLD_UNOWN_E),
    SPECIES_TO_KANTO(OLD_UNOWN_F),
    SPECIES_TO_KANTO(OLD_UNOWN_G),
    SPECIES_TO_KANTO(OLD_UNOWN_H),
    SPECIES_TO_KANTO(OLD_UNOWN_I),
    SPECIES_TO_KANTO(OLD_UNOWN_J),
    SPECIES_TO_KANTO(OLD_UNOWN_K),
    SPECIES_TO_KANTO(OLD_UNOWN_L),
    SPECIES_TO_KANTO(OLD_UNOWN_M),
    SPECIES_TO_KANTO(OLD_UNOWN_N),
    SPECIES_TO_KANTO(OLD_UNOWN_O),
    SPECIES_TO_KANTO(OLD_UNOWN_P),
    SPECIES_TO_KANTO(OLD_UNOWN_Q),
    SPECIES_TO_KANTO(OLD_UNOWN_R),
    SPECIES_TO_KANTO(OLD_UNOWN_S),
    SPECIES_TO_KANTO(OLD_UNOWN_T),
    SPECIES_TO_KANTO(OLD_UNOWN_U),
    SPECIES_TO_KANTO(OLD_UNOWN_V),
    SPECIES_TO_KANTO(OLD_UNOWN_W),
    SPECIES_TO_KANTO(OLD_UNOWN_X),
    SPECIES_TO_KANTO(OLD_UNOWN_Y),
    SPECIES_TO_KANTO(OLD_UNOWN_Z),
};
